...
# adding the header and db connection file
 include ( 'includes/header_login.php' ) ;
 session_start();
 require ( 'includes/connect_db.php' ) ;

 # updating database with payment details 
 $q = "SELECT * FROM users_webflix ORDER BY id DESC LIMIT 1" ;
...
<h1 class="text-center" style="color:#D50e0c;">Thank you for your purchase, please sign in to explore the Premum memberhip!</h1>
  <div id="formContent">
    <!-- Tabs Titles -->
