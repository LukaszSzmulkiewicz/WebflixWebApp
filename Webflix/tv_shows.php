...
$q = "SELECT * FROM tv_shows_webflix WHERE cat_id=1" ;
...
$q = "SELECT * FROM tv_shows_webflix WHERE cat_id=2" ;
...
<h2 style="color:white">Fantasy<h2>
 ...
 <div class="container">
  ...
  <?php  
# Retrieve data from 'tv_shows_webflix' database table.
$q = "SELECT * FROM tv_shows_webflix WHERE cat_id=4" ;
...
<h2 style="color:white">Thriller<h2>
 ...
 <div class="container">
  ...
  <?php  
# Retrieve data from 'tv_shows_webflix' database table.
$q = "SELECT * FROM tv_shows_webflix WHERE cat_id=5" ;
