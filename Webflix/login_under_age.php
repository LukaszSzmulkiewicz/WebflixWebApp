...
<html lang="en">
  ...
  <body>
	<?php # DISPLAY COMPLETE LOGIN PAGE FOR USERS UNDER AGE.
...
<h1 class="text-center" style="color:#D50e0c;">The Premium membership is only available to over 18, you can 
now sign in and explore the free, Basic membership!</h1>
  <div id="formContent">
    <!-- Tabs Titles -->
