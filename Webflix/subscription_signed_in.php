...
<!-- Displaying the membership choices to the user -->
  <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
    <h3 class="display-6 fw-normal"> To watch full content, go Primum!</h3>
 </div>
    ...
    <div class="row row-cols-1 row-cols-md-3 mb-3 text-center">
      ...
      <div class="card mb-4 rounded-3 shadow-sm border-danger">
         ...
         <form action="user_login.php" method="post">
            <button type="submit" class="w-100 btn btn-lg btn-outline-danger" href="login.php">Keep free membership</button>
         </form>
          </div>
        </div>
      </div>
      ...
      <h3 class="display-6 text-center mb-4"><b>VS</b></h3>
        ...
        <div class="card mb-4 rounded-3 shadow-sm border-danger">
          ...
          <div class="card-body">
            ...
            <input type="hidden" name="hosted_button_id" value="S6HJDLJX39234">
