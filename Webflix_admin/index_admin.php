...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
  <header class="mb-auto">
      ...
      <div>
        <h1 class="display-1 mb-auto"style="color: #D50e0c;"><b>Webflix Admin</b></h1>
    </div>



  <main class="px-3">
    <h1>Webflix platform administration portal.</h1>
    ...
    <!-- Button trigger modal -->    
		        <a href="admin_register.php" class="btn btn-dark btn-lg" style="background-color: #D50e0c;">Register</a>
            <button type="button" class="btn btn-dark btn-lg" style="background-color: #D50e0c;" data-toggle="modal" data-target="#register"style="color:#D50e0c">Sign in</button>	
